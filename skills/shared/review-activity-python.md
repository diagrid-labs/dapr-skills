...
| DWF-ACT-009 | warning  | Activity does not type its input/output with Pydantic models                                                                | As of dapr-ext-workflow 1.18, Pydantic models are the first-class input/output type; untyped payloads lose validation and clarity. | Use Pydantic types declared in `models.py` for the activity input and return value. |
